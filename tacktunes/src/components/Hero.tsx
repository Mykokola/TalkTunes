...
export const Hero = () => (
    ...
    <p className=" max-w-lg  pt-10">I am a goal-oriented and responsible person looking for a frontend developer position. I have experience with JavaScript, React,
